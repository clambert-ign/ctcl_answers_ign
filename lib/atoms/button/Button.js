...
Button.propTypes = {
  ...
  icon:             PropTypes.oneOf(['externalLink', 'download', 'terminology', 'bulb', 'advice', 'chevronUp', 'chevronDown', 'chevronLeft', 'chevronRight', 'close', 'audioPlay','audioPlaying','audioPause', 'globe', 'carouselIndicator', 'carouselIndicatorActive', 'play', 'share', 'shareFacebook', 'shareTwitter', 'shareLink', 'shareEmail', 'sharePrint']),
